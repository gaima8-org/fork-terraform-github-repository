...
## [2.0.0](https://github.com/gaima8-org/fork-terraform-github-repository/compare/v1.0.0...v2.0.0) (2025-12-06)


### ⚠ BREAKING CHANGES

* **projects:** Support for classic GitHub Projects has been removed. All resources related to projects are no longer created, and input variables for configuring projects have been deleted. Users relying on these features must update their configurations.

### Miscellaneous Chores

* **projects:** Remove deprecated GitHub Projects support ([97c8b69](https://github.com/gaima8-org/fork-terraform-github-repository/commit/97c8b690d8afda5a797303b59b8a48d5252f936a))
